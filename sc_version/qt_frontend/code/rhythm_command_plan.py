...
from bass_sequence_source import (
    BASS_ACTIVITY_VELOCITY_GAIN as _BASS_ACTIVITY_VELOCITY_GAIN,
    bass_gesture_sources as _bass_gesture_sources,
    scaled_bass_source as _scaled_bass_source,
)
...
BASS_ACTIVITY_VELOCITY_GAIN = _BASS_ACTIVITY_VELOCITY_GAIN
