...
[`../music/sound_balance.md`](../music/sound_balance.md). The MIDI screen does not gain an APG/LDR control.
...
and LED states defined in [`../controls/midi_control.md`](../controls/midi_control.md); an unbound knob remains display-only.
...
the left side of the same button. Details are defined in
[`../controls/midi_control.md`](../controls/midi_control.md).
...
[`../controls/midi_control.md`](../controls/midi_control.md): outgoing flashes red and incoming flashes blue, then outgoing
