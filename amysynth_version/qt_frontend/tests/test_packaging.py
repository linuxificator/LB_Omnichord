...
class PackagingContracts(unittest.TestCase):
    ...
    def test_release_names_and_assets_follow_the_timestamp_contract(self) -> None:
        ...
        self.assertEqual(release.count("actions/attest@"), 4)
        self.assertIn("Attest ESP32-P4 firmware provenance", release)
        self.assertIn("Attest Raspberry Pi realtime setup provenance", release)
        ...
        self.assertIn("Pi4-Pi5-realtime-setup.sh", release)
        ...
        self.assertIn("build_rpi_realtime_setup.py", release)
