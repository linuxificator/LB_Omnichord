...
Every package in the `features/gamma9001` variant contains the Qt frontend and
supported AMY fork with the full Gamma9001 PCM drum bank. At runtime they
remain separate processes connected by the
