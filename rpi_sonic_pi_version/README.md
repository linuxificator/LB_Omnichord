...
python -m pip install -r rpi_sonic_pi_version/requirements.txt
```
...
cp "$HOME/LB_Omnichord/rpi_sonic_pi_version/sonic_pi_receiver.rb" \
...
```bash
source "$HOME/omnichord-env/bin/activate"
cd "$HOME/LB_Omnichord/rpi_sonic_pi_version"
